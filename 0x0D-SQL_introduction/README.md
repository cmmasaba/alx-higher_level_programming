# MySQL - Introduction
Project done during while studying Software Engineering at ALX . It aims to learn about databases, relational databases, subqueries, tables, **MySQL** statements and functions.
